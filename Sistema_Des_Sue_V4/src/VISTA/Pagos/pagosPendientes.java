   ...
   void activarBuscar(){
    ...
    void cargarTablaPagosPendientes(){
        ...
        try{
            ...
            rs=MODELO_CONTROLADOR.Pago.verPagosPendientes(cx);
            while(rs.next()){
    ...
    private void buscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarMouseClicked
       // si el labelBUscar es false , quiere decir que esta accion esta desactivada, por lo tanto 
        if(!labelBuscar){
          return; 
       }
        tabla.setRowCount(0);
        ...
        try{
            ...
            rs=MODELO_CONTROLADOR.Pago.verPagosPendientesAlumnoPorNombre(cx, txtNombre.getText());
            while(rs.next()){
                datos[0]=rs.getString("al.nombre");
                datos[1]=rs.getString("al.apellido");
                datos[2]=rs.getString("al.dni");
