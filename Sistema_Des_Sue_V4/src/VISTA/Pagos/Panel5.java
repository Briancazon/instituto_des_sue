...
public class Panel5 extends javax.swing.JPanel {
    ...
    DefaultComboBoxModel ls2= new DefaultComboBoxModel();
     ...
     boolean labelPagar2 =true;
     boolean labelCancelar2=true;
...
CardLayout cardLayout;
    ...
    void activarPagar(){
     ...
     void desactivarPagar(){
        labelPagar.setEnabled(false);
        labelPagar2=false;
    }
     
     void desactivarCancelar(){
         labelCancelar.setEnabled(false);
         labelCancelar2=false;
     }
     
       void activarCancelar(){
         labelCancelar.setEnabled(true);
         labelCancelar2=true;
     }
   ...
   ////metodo para validar que antes de pagar, no haya campos vacios o invalidos..
    void validarCamposVacios(){
      //  if(txtServicio.getText().isEmpty()){
        //    desactivarPagar();
       // }
        if(txtServicio.getText().equalsIgnoreCase("Clases Personalizadas")){
              ...
              if(txtDni.getText().isEmpty() || txtAlumno.getText().isEmpty() || txtServicio.getText().isEmpty() || txtPrecio.getText().isEmpty() || txtFecha.getText().isEmpty() || boxTipoPago.getSelectedItem().equals("Seleccione un tipo de Pago") || txtRecargo.getText().isEmpty() || txtTotal.getText().isEmpty() || boxMes.getSelectedItem().equals("") || boxMes.getSelectedItem().equals("...")){
                  desactivarPagar();
              }else{
                  activarPagar();
              }
         ...
         if(boxMes.isEnabled()){
             ...
             fechaSeleccionada.setTime(new SimpleDateFormat("dd-MM-yyyy").parse(fecha_hoy));
              ...
              try{
                  ...
                  int codigo_mes=MODELO_CONTROLADOR.Asistencia.obtenerCodigoMes(cx,  boxMes.getSelectedItem().toString());  ///obtenemos el codigo del mes del servicio que quiera pagar
                  int año_inscripcion=MODELO_CONTROLADOR.Inscripcion.obtenerAñoInscripcion(cx, Integer.parseInt(txtDni.getText()));   ///obtenemos el año de inscripcion osea el ciclo lectivo del alumno
                  int mes_inscripcion=MODELO_CONTROLADOR.Inscripcion.obtenerMesInscripcion(cx, Integer.parseInt(txtDni.getText()));  //obtenemos el mes de inscripcion del alumno
                  int dia_inscripcion=MODELO_CONTROLADOR.Inscripcion.obtenerDiaInscripcion(cx, Integer.parseInt(txtDni.getText()));  ///obtenemos el dia de isncripcion del alumno
    ...
    public int  cargarComboBoxMeses(int codigo_inscripcion){
       ...
       try {
            rs = MODELO_CONTROLADOR.Pago.verQueMesesPaga(cx, codigo_inscripcion);

            while (rs.next()) {
               ls2.addElement(rs.getString("me.mes")); 
               tiene = 1; // si entra al while, significa que sí hay meses
            }
    ...
    return tiene;
      ...
      void cargarComboBoxTipoPago(){
         try{
            rs=MODELO_CONTROLADOR.Pago.verTIposPagos(cx);
   ...
   public class FondoPanel2 extends JPanel {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Pagos de Servicios");
        ...
        Pagos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VISTA/Imagenes2/metodo-de-pago.png"))); // NOI18N
        Pagos.setText(" PAGAR");
        ...
        Historial.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VISTA/Imagenes/historial-de-transacciones.png"))); // NOI18N
        ...
        labelPagar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VISTA/Imagenes2/pago.png"))); // NOI18N
        ...
        labelCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VISTA/Imagenes/cancelar_pagos.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(labelCancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(labelCancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(31, 31, 31)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtRecargo, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pagosPendientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VISTA/Imagenes2/pendiente.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addComponent(contenedor, javax.swing.GroupLayout.DEFAULT_SIZE, 974, Short.MAX_VALUE)
        );
   ...
   ///si el label pagar 2 es false, quiere decir que dicha accion esta desactivada, por lo tanto no se tendira que poder continuar con este mouseevent... 
   if(!labelPagar2){
        return;
    }
      try{
           ...
           int codigo_tipo_pago=MODELO_CONTROLADOR.Pago.obtenerCodigoTipoPago(cx, boxTipoPago.getSelectedItem().toString());
           int codigo_alumno=MODELO_CONTROLADOR.Alumno.obtenerCodigo(cx, Integer.parseInt(txtDni.getText()));
           int codigo_inscripcion=MODELO_CONTROLADOR.Inscripcion.buscarCodigo(cx, codigo_alumno);   ///obtiene la inscripcion actual activa del alumno
          Calendar fechaSeleccionada = Calendar.getInstance();
          ...
          // Crear el formateador
           ...
           int codigo_servicio=MODELO_CONTROLADOR.Inscripcion.obtenerCodigoServicio(cx, txtServicio.getText());
           float recargo=Float.parseFloat(txtRecargo.getText());
           
           int codigo_mes=0;
           if(boxMes.isEnabled()){
                     codigo_mes=MODELO_CONTROLADOR.Asistencia.obtenerCodigoMes(cx, boxMes.getSelectedItem().toString());
           }
           ...
           // si el codigo_mes = 0, quiere decir que el servicio es clase personalizada, por lo tanto la validacion es por fecha y año
            int año_inscripcion=MODELO_CONTROLADOR.Inscripcion.obtenerAñoInscripcion(cx, Integer.parseInt(txtDni.getText()));
            
           if (codigo_mes==0){
               rs = MODELO_CONTROLADOR.Pago.evitarDoblesPagosServicioClase(cx, codigo_inscripcion, fechaFormateada, codigo_ciclo_lectivo);
                if (rs.next()){  
               ...
               rs=MODELO_CONTROLADOR.Pago.evitarDoblesPagosServicioMensual(cx, codigo_inscripcion, codigo_mes, codigo_ciclo_lectivo);  //consulta para ver si ya pagó ese mes del ciclo lectivo al que pertenezca esa isncripcion
           ...
           //////insertar el pago...
           MODELO_CONTROLADOR.Pago.pagar(cx, codigo_tipo_pago, codigo_inscripcion, fechaFormateada, codigo_servicio, recargo, codigo_mes, codigo_ciclo_lectivo, obervacion, total);
           JOptionPane.showMessageDialog(null, "Se ha pagado correctamente el servicio");
            ...
            rs=MODELO_CONTROLADOR.Inscripcion.verInfoAlumno(cx, codigo_alumno);
            ...
            String carpeta = userHome + "\\Downloads\\REPORTES\\COMPROBANTES\\comprobantes.pdf";
           ...
           document.add(new Paragraph("Ciclo Lectivo: " +año_inscripcion));
          ...
          rs = MODELO_CONTROLADOR.Tutor.obtenerInfo(cx, codigo_alumno);
          String nombre_tutor = "";
         ...
         int año_inscripcion_alumno=MODELO_CONTROLADOR.Inscripcion.obtenerAñoInscripcion(cx, Integer.parseInt(txtDni.getText()));
         // Creamos el mensaje
         String mensaje = "";
         if (codigo_mes == 0) {
    ...
    private void txtDniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDniActionPerformed
     ///este evento se ejecuta cuando el usuario presione unicamente ENTER,, en caso de que ponga un dni inexistente, saldra el mensaje del catch...
        ...
        try{
         rs=MODELO_CONTROLADOR.Pago.consultarServicioYPrecio(cx, Integer.parseInt(txtDni.getText()));
         while(rs.next()){
         ...
         if (modalidad_cobro == 2) {
            ...
            rs = MODELO_CONTROLADOR.Inscripcion.verDIas(cx, Integer.parseInt(txtDni.getText()));
       ...
       Date fechaActual = new Date();
        ...
        txtFecha.setText(fechaFormateada);
         ...
         if(modalidad_cobro==1){
               ...
               int tiene=cargarComboBoxMeses(codigo_inscripcion);//invocamos al metodo cargarComboBoxMeses que carga los meses que el alumno con servicio mensual asistió.. y guardamos esto en una variable tiene, ya que el metodo devuelve int 0 si no tiene asistencias cargadas, y 1 si si tiene
               ///si el no tiene meses cargados de assitencias, entonces no podrá realizar un pago, ya que no estaría pagando ningun mes..
               if(tiene==0){
                    JOptionPane.showMessageDialog(null, "El alumno "+txtAlumno.getText()+" tiene un servicio Mensual sin asistencias cargadas, antes de realizar un pago de un servicio mensual primero deberá cargar los meses que haya asistido","ERROR",ERROR_MESSAGE);
                    limpiar();
                    return;
               }
               activarBoxMes();
    ...
    private void botonBuscarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarAlumnoActionPerformed
       ...
       // en caso de que ponga un dni inexistente o un alumno que tiene una inscripcio inactiva, saldra el mensaje del catch...
         ...
         if (modalidad_cobro == 2) {
               ...
               while (rs.next()) {
                    ...
                    String[] partes = dias.split(" - ");
                     ...
                     // Obtener el día actual en español (ej: "miércoles")
                     LocalDate hoy = LocalDate.now();
                     String diaEnEspañol = hoy.getDayOfWeek() .getDisplayName(TextStyle.FULL, new Locale("es", "ES"));

                      // === FUNCIÓN LOCAL: NORMALIZAR (elimina tildes y pasa a minúsculas) ===
                      java.util.function.Function<String, String> normalizar = texto -> {
                      if (texto == null) return "";
                         return java.text.Normalizer.normalize(texto, java.text.Normalizer.Form.NFD) .replaceAll("\\p{M}", "")  // elimina tildes
                        .toLowerCase()
                        .trim();
                      };
                      ...
                      // Filtro: solo puede pagar si el día actual coincide con alguno de sus días de cursado
                      if (!dia1Norm.equals(diaHoyNorm) && !dia2Norm.equals(diaHoyNorm)) {
                        JOptionPane.showMessageDialog(null, "El alumno elegido tiene un servicio de clase personalizada de cursado los días: "+ dia1 + " y " + dia2+ ".\nÚnicamente deberá pagar cada clase de los días que curse.","ERROR", ERROR_MESSAGE);
                        return;
                      }
                }   
         }
    ...
    private void PagosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PagosMouseExited
         Pagos.setBackground(new Color(255,153,153));
    ...
    private void HistorialMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_HistorialMouseExited
       Historial.setBackground(new Color(255,153,153));
    ...
    private void pagosPendientesMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pagosPendientesMouseExited
         pagosPendientes.setBackground(new Color(255,153,153));
    ...
    private void labelCancelarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelCancelarMouseEntered
      labelCancelar.setBackground(new Color(255,153,153));
    ...
    private void labelCancelarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelCancelarMouseExited
      labelCancelar.setBackground(new Color(255,102,102));
