    ...
    public void Conteo5(){
     ...
     tabla.setRowCount(0);   
         ...
         try{
             ...
             rs=Consultas.ConsultaServicios.mostrarClasePersonalizada(cx);
              while(rs.next()){
     ...
     public void mostrar2(){
         ...
         try{
             ...
             rs=Consultas.ConsultaServicios.mostrarApoyoPedagogico(cx);
              while(rs.next()){
                   datos[0]=rs.getString("al.nombre");
                   datos[1]=rs.getString("al.apellido");
                   datos[2]=rs.getString("ser.nombre");
       ...
       public void mostrar3(){
         ...
         try{
             ...
             rs=Consultas.ConsultaServicios.mostrarEducacionTemprana(cx);
              while(rs.next()){
                   datos[0]=rs.getString("al.nombre");
                   datos[1]=rs.getString("al.apellido");
                   datos[2]=rs.getString("ser.nombre");
       ...
       public void mostrar4(){
         ...
         try{
             ...
             rs=Consultas.ConsultaServicios.mostrarAcompañamiento(cx);
              while(rs.next()){
                   datos[0]=rs.getString("al.nombre");
                   datos[1]=rs.getString("al.apellido");
                   datos[2]=rs.getString("ser.nombre");
       ...
       public void mostrar5(){
         ...
         try{
             ...
             rs=Consultas.ConsultaServicios.mostrarItinerancia(cx);
              while(rs.next()){
                   datos[0]=rs.getString("al.nombre");
                   datos[1]=rs.getString("al.apellido");
                   datos[2]=rs.getString("ser.nombre");
