...
public class ConsultaGasto extends java.awt.Dialog {
    ...
    private void initComponents() {
        ...
        SeleccionarMes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes2/modificar.png"))); // NOI18N
           ...
           tabla.setRowCount(0);   
              ...
              tabla.addColumn("Precio");
               try{
                    ...
                    rs=Clases.GastosG.mostrarGastosAnteriores(cx, codigo);
                    while(rs.next()){
    ...
    private void SeleccionarMesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SeleccionarMesActionPerformed
     String Seleccionado = mesbox.getSelectedItem().toString();
        ...
        try {
        Clases.GastosG.activarGastosPorMes(Conexion.conexion.conexion(), Seleccionado);
