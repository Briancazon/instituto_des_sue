...
DefaultTableModel tabla=new DefaultTableModel();
    ...
    if (mesbox.isEnabled()) {
        mesbox.setEnabled(false); // estaba habilitado → deshabilitar
        
    } else {
        mesbox.setEnabled(true);  // estaba deshabilitado → habilitar
...
public void guardarGasto() {
       ...
       String mes= mesbox.getSelectedItem().toString(); 
        ...
        try{
           ...
           int codigomes=Clases.GastosG.obtenerCodigo(cx, mes);
            int c_c_l=Clases.GastosG.obtenerCodigoCicloLectivo(cx);
           Clases.GastosG.cargarGastos(cx, nombre, precio, codigomes, c_c_l);
    ...
    try {
        ...
        rs = Clases.GastosG.mostrarPorMes(cx, mesSeleccionado);
...
public void eliminarya() {
          ...
          try{
               Clases.GastosG.desactivarTodosLosGastos(cx);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cargar Gastos");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes2/recursos.png"))); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes2/tutoria.png"))); // NOI18N
        ...
        a.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes2/modificar.png"))); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(preciotxt, javax.swing.GroupLayout.DEFAULT_SIZE, 259, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mesbox, 0, 305, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(a)
                        .addGap(7, 7, 7))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void tablaGMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaGMouseClicked
         ...
         int filaSeleccionada = tablaG.getSelectedRow();
            ...
            try{
               int codigo= Clases.GastosG.obtenerCodigoGastos(cx, nombre);
